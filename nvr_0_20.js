...
const HOSTNAME = 'WINDOWS-F7HL17K';
...
const maxReconnectDelay = 1500; // Max 5 seconds
...
let currentBranch = {
    ...
    branch_code: "ATM-002",
    branch_type: 'ATM',
    address: "First Ring Rd-king Faisal, Bada'ah طريق الملك فيصل , بضاعة Almadinah Almunawarah",
    coordinates: [24.4714083, 39.5753717],
    status: 'online',
    nvrs: []
}
        ...
        ws.on('message', async (data) => {
            try {
                ...
                if (message.type === 'auth_ok') {
                    ...
                    }, 1500); // Changed to 10 seconds (was 1000ms = 1 second)
